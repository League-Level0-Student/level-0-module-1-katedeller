...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		answer = JOptionPane.showInputDialog("You can only see the secret message if you guess the passcode!");
		// 4. If their guess matches the password, show them the secret message
		if (answer.equals("Password")) {
			JOptionPane.showMessageDialog(null, "This is the secret message");
		}
